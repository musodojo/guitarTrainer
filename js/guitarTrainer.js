function init() {
  ...
  // loading screen
  document.getElementById('fullscreen').innerHTML = "<div class='loading'></div>";
  ...
  requestGuitarSprite.onload = function() {
    g_audioContext.decodeAudioData(requestGuitarSprite.response,
      function (buffer) {
...
function onResume() {
  if (document.getElementById("playExerciseDiv") || document.getElementById("playStopFretboard")) {
    document.getElementById("backButton").click();
  }
}

// a "note" object constructor
function Note(stringNumber, fretNumber, noteColor, noteStartTime, noteDuration, noteName, fingerNumber, spriteStartTime, spriteDetune) {
